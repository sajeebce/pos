...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/products/stock-history-serials', [ProductController::class, 'getStockHistorySerials']);
    ...
    Route::get('/products/get-available-serials', [ProductController::class, 'getAvailableSerials']);
    ...
    Route::get('/sells/pos/get-available-serials', [SellPosController::class, 'getAvailableSerials']);
    ...
    Route::get('/reports/due-reports', [ReportController::class, 'getDueReports'])->name('report.due_report');
    Route::get('/reports/due-checking-reports', [ReportController::class, 'getDueCheckingReports'])->name('report.due_checking_report');
    Route::get('/reports/stock-init-reports', [ReportController::class, 'getStockInitReports'])->name('report.stock_init_report');
