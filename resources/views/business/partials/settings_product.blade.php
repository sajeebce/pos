    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('enable_imei_tracking', 1, $business->enable_imei_tracking,
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_imei_tracking' ) }}
                  </label>
                  @show_tooltip(__('lang_v1.tooltip_enable_imei_tracking'))
                </div>
            </div>
        </div>
