                    ...
                    <tr>
                        <td>
                            <table class="table">
                                ...
                                <tr>
                                    <th>@lang('account.customer_payment_due'):</th>
                                    <td>
                                        <input type="hidden" id="hidden_customer_payment_due" class="liability">
                                        <span class="remote-data" id="customer_payment_due">
                                            <i class="fas fa-sync fa-spin fa-fw"></i>
                                        </span>
                                    </td>
                                </tr>
    ...
    function update_balance_sheet(){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $('span#customer_payment_due').text(__currency_trans_from_en(result.customer_payment_due, true));
                __write_number($('input#hidden_customer_payment_due'), result.customer_payment_due);
