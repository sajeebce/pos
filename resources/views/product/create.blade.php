    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <br>
                <label>
                    {!! Form::checkbox('enable_imei_tracking', 1, !(empty($duplicate_product)) ? $duplicate_product->enable_imei_tracking : false, ['class' => 'input-icheck']); !!} <strong>@lang('lang_v1.enable_imei_for_product')</strong>
                </label> @show_tooltip(__('lang_v1.tooltip_enable_imei_tracking'))
            </div>
        </div>
        @endif
