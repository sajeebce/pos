                ...
                @if (auth()->user()->can('dashboard.data'))
                    ...
                    <div class="tw-mt-2 sm:tw-w-1/3 md:tw-w-1/4 tw-text-right">
                        ...
                        <button type="button" id="dashboard_date_filter"
                            class="tw-inline-flex tw-items-center tw-justify-center tw-w-full tw-gap-1 tw-px-3 tw-py-2 tw-text-sm tw-font-medium tw-text-white tw-transition-all tw-duration-200 tw-bg-white tw-rounded-lg sm:tw-w-auto hover:tw-bg-primary-50">
            ...
            @if (auth()->user()->can('dashboard.data'))
                ...
                <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5">
                    ...
                    <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200"
                        style="background: linear-gradient(to right, #9250FC, #AA77FD); border-radius: 15px;">
                        <div class="tw-p-4 sm:tw-p-5"
                            style="background: linear-gradient(to right, #9250FC, #AA77FD); border-radius: 15px;">
                            <div class="tw-flex tw-items-center tw-gap-4">
                                <div class="tw-flex-1 tw-min-w-0">
                                    <p class="tw-text-sm tw-font-medium tw-text-white tw-truncate tw-whitespace-nowrap">
                                        {{ __('home.total_sell') }}
                                    </p>
                                    <p
                                        class="total_sell tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    </p>
                                </div>
                                ...
                                <div
                                    ...
                                    <img src="{{ asset('images/dashboard_icon/total_sales.svg') }}" alt="Icon"
                    ...
                    <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                        style="background: linear-gradient(to right, #F94A47, #FF6461); border-radius: 15px;">
                        <div class="tw-p-4 sm:tw-p-5"
                            style="background: linear-gradient(to right, #F94A47, #FF6461); border-radius: 15px;">
                            <div class="tw-flex tw-items-center tw-gap-4">
                                <div class="tw-flex-1 tw-min-w-0">
                                    ...
                                    <p
                                        class="net tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    </p>
                                </div>

                                <div
                                    class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                    <img src="{{ asset('images/dashboard_icon/net.svg') }}" alt="Icon"
                                        class="tw-w-10 tw-h-10">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                        style="background: linear-gradient(to right, #406EEF, #698FFF); border-radius: 15px;">
                        <div class="tw-p-4 sm:tw-p-5"
                            style="background: linear-gradient(to right, #406EEF, #698FFF); border-radius: 15px;">
                            <div class="tw-flex tw-items-center tw-gap-4">
                                <div class="tw-flex-1 tw-min-w-0">
                                    ...
                                    <p
                                        class="invoice_due tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    </p>
                                </div>

                                <div
                                    class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                    <img src="{{ asset('images/dashboard_icon/due.svg') }}" alt="Icon"
                                        class="tw-w-10 tw-h-10">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                        style="background: linear-gradient(to right, #F56F3A, #FF9972); border-radius: 15px;">
                        <div class="tw-p-4 sm:tw-p-5"
                            style="background: linear-gradient(to right, #F56F3A, #FF9972); border-radius: 15px;">
                            <div class="tw-flex tw-items-center tw-gap-4">
                                <div class="tw-flex-1 tw-min-w-0">
                                    <p class="tw-text-sm tw-font-medium tw-text-white tw-truncate tw-whitespace-nowrap">
                                        ...
                                        <i class="fa fa-info-circle text-white-custom hover-q no-print " aria-hidden="true"
                                    ...
                                    <p
                                        class="total_sell_return tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    </p>
                                ...
                                <div
                                    class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                    <img src="{{ asset('images/dashboard_icon/sell_return.svg') }}" alt="Icon"
                                        class="tw-w-10 tw-h-10">
                                </div>
                            </div>
                        </div>
        ...
        @if (auth()->user()->can('dashboard.data'))
            ...
            <div class="tw-relative">
                <div class="tw-absolute tw-inset-0 tw-grid" aria-hidden="true">
                    <div class="tw-bg-gradient-to-r"></div>
                ...
                <div class="tw-px-5 tw-isolate">
                    <div
                        ...
                        <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                            style="background: linear-gradient(to right, #11B981, #58CEA7); border-radius: 15px;">
                            <div class="tw-p-4 sm:tw-p-5"
                                style="background: linear-gradient(to right, #11B981, #58CEA7); border-radius: 15px;">
                                <div class="tw-flex tw-items-center tw-gap-4">
                                    <div class="tw-flex-1 tw-min-w-0">
                                        <p
                                            class="tw-text-sm tw-font-medium tw-text-white tw-truncate tw-whitespace-nowrap">
                                            {{ __('home.total_purchase') }}
                                        </p>
                                        <p
                                            class="total_purchase tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                        </p>
                                    </div>

                                    <div
                                        class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                        <img src="{{ asset('images/dashboard_icon/purchase.svg') }}" alt="Icon"
                                            class="tw-w-10 tw-h-10">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                            style="background: linear-gradient(to right, #F2A81B, #FDC251); border-radius: 15px;">
                            <div class="tw-p-4 sm:tw-p-5"
                                style="background: linear-gradient(to right, #F2A81B, #FDC251); border-radius: 15px;">
                                <div class="tw-flex tw-items-center tw-gap-4">
                                    <div class="tw-flex-1 tw-min-w-0">
                                        <p class="tw-text-sm tw-font-medium tw-text-white">
                                            {{ __('home.purchase_due') }}
                                        </p>
                                        <p
                                            class="purchase_due tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    ...
                                    <div
                                        class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                        <img src="{{ asset('images/dashboard_icon/purchase_due.svg') }}" alt="Icon"
                                            class="tw-w-10 tw-h-10">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200"
                            style="background: linear-gradient(to right, #F33394, #FA6BB3); border-radius: 15px;">
                            <div class="tw-p-4 sm:tw-p-5"
                                style="background: linear-gradient(to right, #F33394, #FA6BB3); border-radius: 15px;">
                                <div class="tw-flex tw-items-center tw-gap-4">
                                    <div class="tw-flex-1 tw-min-w-0">
                                        <p
                                            ...
                                            <i class="fa fa-info-circle text-white-custom hover-q no-print "
                                        ...
                                        <p
                                            class="total_purchase_return tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                        </p>
                                    ...
                                    <div
                                        class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                        <img src="{{ asset('images/dashboard_icon/purchase_return.svg') }}"
                                            alt="Icon" class="tw-w-10 tw-h-10">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tw-p-4 sm:tw-p-5"
                                ...
                                <div class="tw-flex tw-items-center tw-gap-4">
                                    <div class="tw-flex-1 tw-min-w-0">
                                        ...
                                        <p
                                            class="total_expense tw-mt-0.5 tw-text-white tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                    ...
                                    <div
                                        class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 shrink-0 bg-sky-100 tw-text-sky-500">
                                        <img src="{{ asset('images/dashboard_icon/expense.svg') }}" alt="Icon"
                                            class="tw-w-10 tw-h-10">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped" id="sales_payment_dues_table"
                                            style="width: 100%; background: #FBFAFF !important; color: #5720B7 !important;">
                                            <thead>
                                                <tr>
