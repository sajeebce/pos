@component('components.static', [
    ...
    <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
        ...
        <i class="fa fa-info-circle text-white hover-q no-print " aria-hidden="true" data-container="body" data-toggle="popover"
            data-placement="auto bottom" id="total_prp_{{ $dashboard_detail->index }}"
