...
@section('content')
    ...
    <section class="content">
        <div class="print_section">
            <h2 style="text-align: center; margin: 0 auto";>{{ session()->get('business.name') }} - @lang('report.profit_loss')</h2>
            <p id="print_date_range" style="text-align: center; font-size: 24px; font-weight: 600; margin: 0 auto;">
                @if (request()->has('start_date') && request()->has('end_date'))
                    @lang('messages.from'): {{ \Carbon\Carbon::parse(request()->get('start_date'))->format('d M Y') }}
                    - @lang('messages.to'): {{ \Carbon\Carbon::parse(request()->get('end_date'))->format('d M Y') }}
                @else
                    @lang('messages.from'): - @lang('messages.to'):
                @endif
            </p>
        </div>
        ...
        <div class="row no-print">
            ...
            ><i class="fa fa-print"></i> @lang( 'messages.print' )</button> --}}
                ...
                <button class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right" aria-label="Print" id="print_button">
            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#profit_by_service_staff" data-toggle="tab" aria-expanded="true"><i
...
@section('javascript')
    ...
    <script type="text/javascript">
        $('#print_button').click(function() {
            var start_date = $('#profit_loss_date_filter').data('daterangepicker').startDate.format('DD-MMM-YYYY');
            var end_date = $('#profit_loss_date_filter').data('daterangepicker').endDate.format('DD-MMM-YYYY');
            $('#print_date_range').text('From: ' + start_date + ' To: ' + end_date);
            window.print();
        });
