...
<head>
    ...
    <style>
        :root {
            --primary-color: #482497;
            --gradient-start: #270f4d;
            --gradient-end: #56388B;
            --hover-bg-color: #F5F3FF;
            --light-bg-color: #F5F3FF;
            --white: #fff;
        }
        ...
        .tw-tracking-tight .text-white {
            color: var(--primary-color) !important;
            /* font-weight: 500 !important; */
        }

        .tw-flex.tw-items-center.tw-gap-3.tw-px-3.tw-py-2.tw-text-sm.tw-font-medium.tw-tracking-tight.text-white,
        .tw-flex.tw-items-center.tw-gap-3.tw-px-3.tw-py-2.tw-text-sm.tw-font-medium.tw-tracking-tight.text-white:hover {
            color: var(--primary-color) !important;
            /* font-weight: 500 !important; */
        }

        .tw-text-primary-700 .text-white-white {
            color: var(--primary-color) !important;
            /* font-weight: 500 !important; */
        }
    ...
    @if (auth()->user()->id == 4 || auth()->user()->id == 73)
