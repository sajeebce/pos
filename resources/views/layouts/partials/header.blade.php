...
<div class="tw-transition-all tw-duration-5000 tw-border-b tw-shrink-0 lg:tw-h-15 tw-border-primary-500/30 no-print"
    style="background-color: #fff !important;">
    <div class="tw-px-5 tw-py-3">
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            <div class="tw-flex tw-items-center tw-gap-3">
                <button type="button"
                    class="small-view-button xl:tw-w-20 lg:tw-hidden tw-inline-flex tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black tw-transition-all tw-duration-200 tw-p-1.5 tw-rounded-lg tw-ring-1 hover:tw-text-black tw-ring-black/10">
                ...
                <button type="button"
                    class="side-bar-collapse tw-hidden lg:tw-inline-flex tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black tw-transition-all tw-duration-200 tw-p-1.5 tw-rounded-lg tw-ring-1 hover:tw-text-black tw-ring-black/10">
                    <span class="tw-sr-only">
                        Collapse Sidebar
                    </span>
                    <svg aria-hidden="true" class="tw-size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    <summary
                        class="tw-inline-flex tw-transition-all tw-ring-1 tw-ring-black/10 hover:tw-text-black tw-cursor-pointer tw-duration-200 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black tw-gap-1">
                        <svg aria-hidden="true" class="tw-size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round"
                            stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <button id="btnCalculator" title="@lang('lang_v1.calculator')" data-content='@include('layouts.partials.calculator')'
                    ...
                    class="tw-hidden md:tw-inline-flex tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black tw-transition-all tw-duration-200 tw-p-1.5 tw-rounded-lg tw-ring-1 hover:tw-text-black tw-ring-black/10">
                ...
                @if (in_array('pos_sale', $enabled_modules))
                    @can('sell.create')
                        <a href="{{ action([\App\Http\Controllers\SellPosController::class, 'create']) }}"
                            class="sm:tw-inline-flex tw-transition-all tw-duration-200 tw-gap-2 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-ring-1 tw-ring-black/10 hover:tw-text-black tw-text-black"
                            style="color: #482497 !important;">
                ...
                @can('profit_loss_report.view')
                    <button type="button" type="button" id="view_todays_profit" title="{{ __('home.todays_profit') }}"
                        ...
                        class="tw-hidden sm:tw-inline-flex tw-items-center tw-ring-1 tw-ring-black/10 tw-justify-center tw-text-sm tw-font-medium tw-text-black hover:tw-text-black tw-transition-all tw-duration-200 tw-p-1.5 tw-rounded-lg"
                        style="color: #482497 !important;">
                        <span class="tw-sr-only">
                            Today's Profit
                        </span>
                ...
                <button type="button"
                    class="tw-hidden lg:tw-inline-flex tw-transition-all tw-ring-1 tw-ring-black/10 tw-duration-200 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black hover:tw-text-black tw-font-mono">
                    {{ @format_date('now') }}
                </button>
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    <summary data-toggle="popover"
                        class="tw-dw-m-1 tw-inline-flex tw-transition-all tw-ring-1 tw-ring-black/10 tw-cursor-pointer tw-duration-200 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-black hover:tw-text-black tw-gap-1">
