...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action(
                [\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'update'],
                [$production_purchase->id],
            ),
            'method' => 'put',
            'id' => 'production_form',
            'files' => true,
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id', $business_locations, $production_purchase->location_id, [
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('variation_id_shown', $recipe_dropdown, $purchase_line->variation_id, [
                            'class' => 'form-control',
                            'placeholder' => __('messages.please_select'),
                            'required',
                            'disabled',
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="@if (!empty($sub_units)) input_inline @else input-group @endif"
                            ...
                            {!! Form::text('quantity', @format_quantity($quantity), [
                                'class' => 'form-control input_number',
                                'id' => 'recipe_quantity',
                                'required',
                                'data-rule-notEmpty' => 'true',
                                'data-rule-notEqualToWastedQuantity' => 'true',
                            ]) !!}
            ...
            <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('exp_date', !empty($purchase_line->exp_date) ? @format_date($purchase_line->exp_date) : null, [
                                    'class' => 'form-control',
                                    'readonly',
                                ]) !!}
                            </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::text('mfg_wasted_units', @num_format($production_purchase->mfg_wasted_units), [
                                'class' => 'form-control input_number',
                            ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input_inline">
                            {!! Form::text('production_cost', @num_format($production_purchase->mfg_production_cost), [
                                'class' => 'form-control input_number',
                            ]) !!}
                            <span>
                                {!! Form::select(
                                    ...
                                    [
                                        ...
                                        'per_unit' => __('manufacturing::lang.per_unit'),
                                    ],
                                    $production_purchase->mfg_production_cost_type,
                                    ['class' => 'form-control', 'id' => 'mfg_production_cost_type'],
                                ) !!}
                            </span>
                        </div>
                        <p><strong>
