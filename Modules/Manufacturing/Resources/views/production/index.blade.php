        ...
        @component('components.filters', ['title' => __('report.filters')])
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('productstion_list_filter_location_id', $business_locations, null, [
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('production_list_filter_date_range', null, [
        ...
        @component('components.widget', ['class' => 'box-solid'])
            @slot('tool')
                <div class="box-tools">
                    ...
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 primary_bg_color tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
