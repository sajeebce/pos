...
@section('content')
        ...
        @component('components.widget', ['class' => 'box-solid'])
            @can('manufacturing.add_recipe')
                @slot('tool')
                    <div class="box-tools">
                        <button
                            class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 primary_bg_color tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right btn-modal"
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="recipe_table">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="8">
                                <button type="button" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error"
                                    id="mass_update_product_price">@lang('manufacturing::lang.update_product_price')</button>
    ...
    <!-- /.content -->
    <div class="modal fade" id="recipe_modal" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
@stop
@section('javascript')
