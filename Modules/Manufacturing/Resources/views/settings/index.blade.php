...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action([\Modules\Manufacturing\Http\Controllers\SettingsController::class, 'store']),
            'method' => 'post',
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text(
                                            'ref_no_prefix',
                                            !empty($manufacturing_settings['ref_no_prefix']) ? $manufacturing_settings['ref_no_prefix'] : null,
                                            ['placeholder' => __('manufacturing::lang.mfg_ref_no_prefix'), 'class' => 'form-control'],
                                        ) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox(
                                                    ...
                                                    ['class' => 'input-icheck', 'id' => 'disable_editing_ingredient_qty'],
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox(
                                                    ...
                                                    ['class' => 'input-icheck', 'id' => 'enable_updating_product_price'],
