@if ($__is_repair_enabled)
    @can('repair.create')
        ...
        <a href="{{ action([\App\Http\Controllers\SellPosController::class, 'create']) . '?sub_type=repair' }}"
            ...
            class="tw-hidden sm:tw-inline-flex tw-transition-all tw-duration-200 tw-gap-2 tw-ring-black/10 tw-bg-black tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-ring-1 tw-ring-white/10 tw-text-white hover:tw-text-white"
            style="color: #482497 !important; border: 1px solid #482497;">
