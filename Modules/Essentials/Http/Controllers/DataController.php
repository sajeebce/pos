        ...
        if ($is_essentials_enabled) {
            Menu::modify('admin-sidebar-menu', function ($menu) {
                $menu->url(
                    ...
                    ['icon' => 'images/sidebar_icon/hrm.svg', 'active' => request()->segment(1) == 'hrm', 'style' => config('app.env') == 'demo' ? 'background-color: #605ca8 !important;color:white' : '']
                )
                    ->order(87);
                ...
                $menu->url(
                    ...
                    ['icon' => 'images/sidebar_icon/essentials.svg', 'active' => request()->segment(1) == 'essentials', 'style' => config('app.env') == 'demo' ? 'background-color: #001f3f !important;color:white' : '']
                )
                    ->order(87);
            });
        }
