...
return [
    ...
    'tooltip_sr_no' => 'Enable or disable adding product description/note while selling products in POS screen',
    'description' => 'Description',
    'sell_line_description_help' => 'Add product description or additional notes here.',
    ...
    'total_purchase_return_paid' => 'Total Purchase Return Received',
    'total_purchase_return_inc_tax' => 'Total Purchase Return Including Tax',
    'purchase_sell_report_formula' => 'Overall (Sale - Sale Return - Purchase)',
    ...
    'net' => 'Net',
    'net_home_tooltip' => 'NET = TOTAL SALES - INVOICE DUE - EXPENSE - TOTAL SELL RETURN (PAID)',
    ...
    'in_stock' => 'in stock',
    'cogs' => 'COGS:',
    'cogs_help_text' => 'Cost of Goods Sold = Starting inventory(opening stock) + purchases − ending inventory(closing stock) - purchase return',
    ...
    'enable_imei_tracking' => 'Enable IMEI/Serial Number Tracking',
    'tooltip_enable_imei_tracking' => 'Enable tracking of individual serial numbers (IMEI, Serial No, etc.) for products. When enabled, you can input serial numbers during purchase and select specific serial numbers during sale.',
    'imei_serial_number' => 'IMEI/Serial Number',
    'enter_imei_numbers' => 'Enter IMEI/Serial Numbers (one per line)',
    'enter_imei_numbers_placeholder' => 'Enter IMEI/Serial Numbers (one per line or comma separated)',
    'select_imei' => 'Select IMEI/Serial Number',
    'available_serials' => 'Available Serial Numbers',
    'serial_already_exists' => 'This serial number already exists',
    'serial_not_available' => 'No serial number available for this product',
    'serial_required' => 'Please select a serial number for IMEI-enabled products',
    'scan_or_select_imei' => 'Scan barcode or select IMEI',
    'serials_added_successfully' => 'Serial numbers added successfully',
    'enable_imei_for_product' => 'Enable IMEI Tracking for this product',
    'enable_imei_for_purchase' => 'Enable IMEI for this purchase',
    'imei_qty_mismatch' => 'IMEI count must match quantity!',
    'duplicate_imei_found' => 'Duplicate IMEI found: :imei',
    'imei_already_in_system' => 'IMEI already exists in system: :imei',
    'imei_validation_failed' => 'IMEI validation failed',
    'select_imei_for_sale' => 'Select IMEI for sale',
    'selected_imei_count' => ':count selected',
    'available_imei_count' => ':count available',
    'search_imei' => 'Search IMEI...',
    'load_more_imei' => 'Load more...',
    'no_imei_found' => 'No IMEI found',
    'imei_sold' => 'IMEI Sold',
    'imei_available' => 'IMEI Available',
    'view_imei_list' => 'View IMEI List',
    'select_imei_to_return' => 'Select IMEI to return',
    'imei_returned_to_supplier' => 'IMEI Returned to Supplier',
    'selected' => 'selected',
