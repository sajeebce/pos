...
class Product extends Model
{
    ...
    /**
     * Get the serial numbers associated with the product.
     */
    ...
    /**
     * Get available serial numbers for the product.
     */
    public function availableSerials()
    {
        return $this->hasMany(\App\ProductSerial::class)->where('status', 'available');
    }
